...
internal class Client
{
    ...
    private readonly int clientId; // Add clientId field

    public Client(BankAccount account, int clientId) // Modify constructor to accept clientId
    {
        this.account = account;
        this.clientId = clientId; // Store clientId
        random = new Random();
        operating = true;
